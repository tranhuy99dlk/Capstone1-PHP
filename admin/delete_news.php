    ...
    $conn = connectsql();
           if (isset($_POST['tai_len'])) {
                if($_SERVER["REQUEST_METHOD"]=="POST"){
                   if(isset($_POST['danh_muc_tin'])){
                          $tieude = $_POST['danh_muc_tin'];
                  }
                   $sql_update = "UPDATE news SET status=0 WHERE title = '$tieude'";
            ...
            <div class="p-5">
              ...
              <form class="user" method="post">
                <div class="form-group row">
                     <select  name="danh_muc_tin" class="col-sm-12 mb-3 mb-sm-0" style="border-radius: 80px !important;color: #9E9E9E !important;font-size: .8rem;" selected="selected">
                                      <option >--Chọn--</option>

                             <?php 
                                $sql = "SELECT title FROM news ORDER BY news_id ASC";
