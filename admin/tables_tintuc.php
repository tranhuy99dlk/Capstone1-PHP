  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Quản lý tin tức <sup></sup></div>
      </a>
         ...
         <!--  <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="https://datatables.net">official DataTables documentation</a>.</p> -->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Bảng dữ liệu tin tức</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="table-layout:fixed;">
                  <thead>
                    ...
                    <?php while ($row = mysqli_fetch_array($query)) {?>
                      <tr>
                        <td id="new_id"><?php echo $row['news_id'];?></td>
                        <td><?php echo $row['category_id'];?></td>
                        <td><?php echo $row['title'];?></td>
                        <td><?php echo $row['description'];?></td>
                        <td><?php echo $row['content'];?></td>
                        <td><?php echo $row['new_source'];?></td>
                         <td><?php $status= $row['status']; if($status==0) echo "Chưa kích hoạt";
                        else echo "đã kích hoạt";?></td>
                         <td>
                          <button type="submit" style="width: 60px;"><a href="add_update_news.php">Thêm</a></button>
                          <button type="submit" style="width: 60px;"><a href="update_news.php">Sửa </a></button>
                          <button type="submit" style="width: 60px;"><a href="delete_news.php">Xóa</a></button>
                        </td>
                      </tr>
                  <?php } ?>
                </table>
