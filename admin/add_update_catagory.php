...
include('connsql.php');
    ...
    if(isset($_POST['category_name'])){
      ...
      if(!empty(addslashes(trim($cate_name))))
      {
         if(isset($_POST['category_name'])){
            $cate_des = $_POST['description'];
          }
           if(!empty(addslashes(trim($cate_des))))
          {
              $sql_add = "INSERT INTO categoty(category_id,category_name,description,status) VALUES('','$cate_name','$cate_des',1)";
            ...
            <div class="p-5">
              ...
              <form class="user" method="post">
                <div class="form-group">
                     ...
                     <input type="text" class="form-control form-control-user" id="exampleCategory" placeholder="Danh mục" name="category_name">
                </div>
                <div class="form-group">
                
                     <input type="text" class="form-control form-control-user" id="exampleDes" placeholder="Mô tả" name="description">
