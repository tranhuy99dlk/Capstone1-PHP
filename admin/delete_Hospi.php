    ...
    $conn = connectsql();
           if (isset($_POST['tai_len'])) {
                if($_SERVER["REQUEST_METHOD"]=="POST"){
                   if(isset($_POST['danh_muc_tieude'])){
                    $cate_tieude =$_POST["danh_muc_tieude"];
                  }

                  $sql_del = "UPDATE tuvan SET status=0 WHERE TieuDe='$cate_tieude'";
            ...
            <div class="p-5">
              ...
              <form action=""class="user" method="post">
                <div class="form-group row">
                   <select  name="danh_muc_tieude" class="col-sm-12 mb-3 mb-sm-0" style="border-radius: 80px !important;color: #9E9E9E !important;font-size: .8rem;" selected="selected">
                                      <option >--Chọn--</option>

                             <?php 
                             $a= "SELECT title FROM tuvan ORDER BY id ASC";
